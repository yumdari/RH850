...
Macro definitions
***********************************************************************************************************************/
#define _TAUB0_CHANNEL0_COMPARE_VALUE                              (0x0079U) /* Data register for compare values */
#define _TAUB0_CHANNEL8_COMPARE_VALUE                              (0x003DU) /* Data register for compare values */
