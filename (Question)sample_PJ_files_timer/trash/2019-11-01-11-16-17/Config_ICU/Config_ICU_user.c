...
/***********************************************************************************************************************
* Function Name: r_Config_ICU_intp12_interrupt
* Description  : This function is INTP12 interrupt service routine
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
#pragma ghs interrupt
void r_Config_ICU_intp12_interrupt(void)
{
    /* Start user code for r_Config_ICU_intp12_interrupt. Do not edit comment generated here */
    static char input_cnt = 0;

	if(input_cnt == 0)
	{
	  input_cnt = 1;	
      R_Config_TAUD0_0_Stop();
      R_Config_TAUD0_1_Start();
	}
	else
	{
	  input_cnt = 0;	
