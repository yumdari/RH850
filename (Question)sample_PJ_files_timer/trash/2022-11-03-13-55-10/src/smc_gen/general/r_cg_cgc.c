...
void R_CGC_Create(void)
{
    ...
    /* CPU clock setting */
    WPROTR.PROTCMD1 = _WRITE_PROTECT_COMMAND;
    CLKCTL.CKSC_CPUCLKS_CTL = _CGC_PPLLCLK_SOURCE_EMCLK;
    CLKCTL.CKSC_CPUCLKS_CTL = (uint32_t) ~_CGC_PPLLCLK_SOURCE_EMCLK;
    CLKCTL.CKSC_CPUCLKS_CTL = _CGC_PPLLCLK_SOURCE_EMCLK;
    while (CLKCTL.CKSC_CPUCLKS_ACT != _CGC_PPLLCLK_SOURCE_EMCLK)
    {
        NOP();
    }
    WPROTR.PROTCMD1 = _WRITE_PROTECT_COMMAND;
